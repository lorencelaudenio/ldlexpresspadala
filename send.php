...
if(isset($_POST['send'])){
    ...
    echo '<center><div class="alert alert-info fade in alert-dismissible show">Money has been sent. Please note the transaction code is <b><a data-toggle="tooltip" data-placement="right" title="Click to print receipt!" href="print.php" target="_BLANK" class="printlink">' . $txn_numbah . '</a></b>!
